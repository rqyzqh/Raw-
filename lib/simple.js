	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363302593776856@newsletter',
            newsletterName: '𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 ⚡︎', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363302593776856@newsletter", "120363302593776856@newsletter", "120363302593776856@newsletter", "120363302593776856@newsletter"]
let canalNombre = ["@𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎", "@𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎", "𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 ⚡︎", "𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 ⚡︎"]
