...
const smsSaludo = () => { return ` !HOLA! BIENVENIDO(A) RAW 🦕`}
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE BOT RAW 🦕🌟`}
...
const smsLista7 = () => { return `🦕 INSTALAR BOT RAW ✨`}
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *NO LE SUPO AL GRUPO ESE WEY ESCÚPANLO* 🗣️\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
//_allantilink.js
const smsTextoYT = () => { return '🌷 Raw Bot - WhatsApp'} 
...
//handler.js
const smsCont1 = () => { return `* ‼️ESTE COMANDO ESTÁ FALLANDO‼️ *`}
...
//Texto
const smsConMenu = () => { return `🌷 M E N U  R A W 🦕`} //🟡 NO CAMBIAR 
...
//_antitoxic.js
const smsToxic1 = () => { return `NO DIGAS ESA PALABRA WE!! 😤`}
...
const smsToxic7 = () => { return `𝙎𝙐𝙋𝙀𝙍𝘼𝙎𝙏𝙀 𝙇𝘼𝙎 4 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼𝙎 𝘼𝙃𝙊𝙍𝘼 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼) POR WEY😒`}
...
const eGataCoins = () => { return '🦕 DinoCoins' }
const eGataTickers = () => { return '🎫 Dino Tickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Flash Bot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Flash Bot en Grupos`}
...
//grupo-tagall.js
const smstagaa = () => { return `🗣️‼️INVOCANDO AL GRUPO 🗣️‼️`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Flash Bot ⚡'}
