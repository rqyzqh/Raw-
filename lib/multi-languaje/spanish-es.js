...
smsAutodetec7: (m, usuario) =>  `*╭──────────────────*\n*│*\n*│❏ Nuevo Admin Del Mejor Grupo De Whatsapp ✨*\n*│*\n*│❏ Usuario:* @${m.messageStubParameters[0].split`@`[0]}\n*│❏ Admin:* ${usuario}\n*│*\n*╰──────────────────*`, 
smsAutodetec8: (m,  usuario) => `*╭──────────────────*\n*│*\n*│❏ Un Admin Menos Del Mejor Grupo De Whatsapp ✨*\n*│*\n*│❏ Usuario:* @${m.messageStubParameters[0].split`@`[0]}\n*│❏ Admin:* ${usuario}\n*│*\n*╰──────────────────*`, 
...
//grupos
smsAdd: 'Hola! me presento, soy RAW 🦕, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias🌷!!', 
...
//comando +18
smshorny: "𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙑𝘼𝙇𝙄𝘿𝙊 𝘿𝙀 PHUB, 𝙀𝙅𝙀𝙈𝙋𝙇𝙊:", 
